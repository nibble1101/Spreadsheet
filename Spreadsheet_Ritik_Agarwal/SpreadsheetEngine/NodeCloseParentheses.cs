// <copyright file="NodeCloseParentheses.cs" company="PlaceholderCompany">
...
namespace CPTS321
{
    ...
    /// </summary>
    internal class NodeCloseParentheses : NodeOperator
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NodeCloseParentheses"/> class.
        /// </summary>
        public NodeCloseParentheses()
            : base(')')
        {
        }
