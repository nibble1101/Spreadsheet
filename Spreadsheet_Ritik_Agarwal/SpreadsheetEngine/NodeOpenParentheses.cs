// <copyright file="NodeOpenParentheses.cs" company="PlaceholderCompany">
...
namespace CPTS321
{
    ...
    /// </summary>
    internal class NodeOpenParentheses : NodeOperator
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NodeOpenParentheses"/> class.
        /// </summary>
        public NodeOpenParentheses()
            : base('(')
        {
        }
